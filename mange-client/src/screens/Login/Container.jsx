...
export const SignInSection = ({ authFailure, validationSequence, setUserValidationSequence , setPasswordRecovery, passwordRecovery, recoveryFailure}) => {
   ...
   */
    ...
    } = USE_CUSTOM_POST_HOOK('/api/users/create', 'POST');
  ...
  } = USE_CUSTOM_POST_HOOK('/api/users/login', 'POST');
    ...
    >
          <Box className='form'>
            ...
            <CreateAccountForm 
              ...
              createUser={setCreateUser}  // controls which form we are seeeing, signin or create user
            /> :
            <SignInForm 
            ...
            <Box sx={{
              ...
              </Typography>
              {
                ...
                <>
                  ...
                  <Typography sx={{ mt: 2 }}>
                    Please review, the{' '}
                    <a href="https://www.termsfeed.com/live/e83ebcc4-6fe8-4881-80f8-7dfa5fd67c38" target="_blank" rel="noopener noreferrer">
                      Terms & Conditions
                    </a>
                    <br></br>
                    <a href="https://www.termsfeed.com/live/b713ea15-fd91-470b-99b2-8d730147102d" target="_blank" rel="noopener noreferrer">
                      Privacy Policy
                    </a>
                    .
                  </Typography>
