...
public class TokenValidationController {
    ...
    // create and endpoint that refreshes the token for the user
        // be sure to use the correct JWTutil method: public String generateToken(JWT_DTO jwtDto) { // this JWT is for the app session
}